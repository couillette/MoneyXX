...
public class UserSettingsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_user_settings,
				container, false);

		// Display message
		TextView settings = (TextView) rootView
				.findViewById(R.id.textView_Settings_User);
		...
		final AutoCompleteTextView autoComp_username = (AutoCompleteTextView) rootView
				.findViewById(R.id.AutoComp_Settings_Username);
		autoComp_email = (AutoCompleteTextView) rootView
				.findViewById(R.id.AutoComp_Settings_Email);
		autoComp_phone = (AutoCompleteTextView) rootView
				.findViewById(R.id.AutoComp_Settings_Phone);
		...
		Button b = (Button) rootView
				.findViewById(R.id.button_Settings_UserSave);
...
>>>>>>> 82a705e5cc7ded006539433bcf03489da27c2784
				...
				phoneData.savePrefs(getActivity(), "USERNAME", name);
				phoneData.savePrefs(getActivity(), "EMAIL", email);
				phoneData.savePrefs(getActivity(), "ACCOUNTID",
						accountID.trim());
				phoneData.savePrefs(getActivity(), "BANKRIB", bankR);
				phoneData.savePrefs(getActivity(), "CREDITCARD", creditC);
				phoneData.savePrefs(getActivity(), "SOLDE", "" + solde);
